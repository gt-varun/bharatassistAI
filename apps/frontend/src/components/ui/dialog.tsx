  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-lg border border-rule bg-surface p-6 text-ink shadow-pop',
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded p-1.5 text-ink-3 transition-colors hover:bg-rule-soft hover:text-ink focus:outline-none focus-visible:ring-2 focus-visible:ring-sanction/60">
        <X className="h-4 w-4" />
