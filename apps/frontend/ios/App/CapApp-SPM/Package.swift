...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorCommunityTextToSpeech", path: "../../../../../node_modules/.pnpm/@capacitor-community+text-to-speech@8.0.2_@capacitor+core@8.5.0/node_modules/@capacitor-community/text-to-speech"),
